...
async function inspectHyro() {
  ...
  console.log("=== SEARCHING GMAIL FOR HYRO & JOINUS ===");
  const searchRes = await gmail.users.messages.list({
    userId: 'me',
    q: 'hyro OR joinus OR "join us"'
  });

  const messages = searchRes.data.messages || [];
  console.log(`Found ${messages.length} messages for Hyro / Joinus.`);
...
inspectHyro().catch(console.error);
